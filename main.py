...
def draw_start_button():
    ...
    button_rect = button_text.get_rect(center=(400, 300))  # Centro del botón
    pygame.draw.rect(screen, (0, 255, 0), button_rect.inflate(20, 10))  # Botón verde
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if button_rect.collidepoint(mouse_pos):
                    game_active = True  # Cambia el estado del juego a activo
    else:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                running = False
